...
type SetPasswordState = "loading" | "ready" | "expired" | "success" | "error";

/**
 * Public password setup page used after /auth/confirm (recovery / invite).
 * Accepts the temporary session established by verifyOtp cookies.
 */
export default function SetPasswordPage() {
  ...
  const [state, setState] = useState<SetPasswordState>("loading");
  ...
  if (state === "loading") {
    return (
      <AuthShell
        title="Definir senha"
        description="Validando o link de acesso..."
      >
  ...
  if (state === "expired") {
    return (
      <AuthShell
        title="Link expirado"
        description="Este link não é mais válido."
        footer={
  ...
  return (
    <AuthShell
      title="Definir senha"
      description="Escolha uma nova senha para acessar o Casaflux."
