  ...
  return (
    <ThemeProvider>
      <ConfirmDialogProvider>
        <QuickAddRoot>
        <div className="app-canvas relative flex min-h-svh bg-background">
          <AppSidebar />
          ...
          <div className="relative z-[1] flex min-w-0 flex-1 flex-col">
            ...
            <main className="relative flex-1 overflow-auto pb-[calc(8.5rem+env(safe-area-inset-bottom,0px))] lg:pb-24">
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-primary/[0.07] via-transparent to-transparent dark:from-primary/[0.12]"
              />
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,var(--tw-gradient-stops))] from-primary/[0.035] via-transparent to-transparent dark:from-primary/[0.07]"
              />
