-- Allow Inter checking CSV imports alongside Nubank sources.
...
alter table public.import_batches
  ...
  check (source in ('nubank_checking', 'nubank_credit_card', 'inter_checking'));
...
begin
  ...
  if p_source not in ('nubank_checking', 'nubank_credit_card', 'inter_checking') then
