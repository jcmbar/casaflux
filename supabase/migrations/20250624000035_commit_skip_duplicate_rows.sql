-- Skip already-imported rows during commit instead of aborting the whole batch.
-- Returns skipped source lines so the client can show a friendly partial-import message.
