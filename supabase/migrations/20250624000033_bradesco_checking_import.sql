-- Allow Bradesco checking CSV imports alongside Nubank and Inter sources.
...
alter table public.import_batches
  ...
  check (source in ('nubank_checking', 'nubank_credit_card', 'inter_checking', 'bradesco_checking'));
